...
-- Name: Waking the Beast Full Moon II
-----------------------------------
...
local content = Battlefield:new({
    id               = "WAKING_THE_BEAST_FULLMOON_II", -- FIXED: Added explicit string tracking identifier
    zoneId           = xi.zone.FULL_MOON_FOUNTAIN,
    battlefieldId    = (xi.battlefield and xi.battlefield.id and xi.battlefield.id.WAKING_THE_BEAST_FULLMOON_II) or 13, -- Protected prefix guard
    maxPlayers       = 6,
    timeLimit        = utils.minutes(30),
    index            = 5,
    entryNpc         = 'MS_Entrance',
    exitNpc          = 'Moon_Spiral',
    requiredKeyItems = { xi.keyItem.WAKING_THE_BEAST_PHANTOM_GEM, keep = false  },
    allowTrusts      = true,
})
...
-- FIXED: Split registration layer invocation from return target line to keep the lookup table happy
content:register()
return content
