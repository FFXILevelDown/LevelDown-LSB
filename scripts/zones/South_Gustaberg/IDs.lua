...
zones[xi.zone.SOUTH_GUSTABERG] =
{
    text =
    {
        ...
        NOTHING_SEEMS_HAPPENING       = 7426, -- Nothing seems to be happening.
        YOU_PUT_ITEM_DOWN             = 7427, -- You put <item> down.
    ...
    mob =
        {
            CARNERO       = GetTableOfIDs('Carnero'), -- TODO: Implement both NMs, there are 2 IDs
