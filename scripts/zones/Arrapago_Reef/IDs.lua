...
zones[xi.zone.ARRAPAGO_REEF] =
{
    text =
    {
        ...
        STAGING_GATE_ILRUSI           = 7336, -- Ilrusi Atoll Staging Point.
        ...
        YOU_NO_REQS                   = 7916, -- You do not meet the requirements to enter the battlefield with your party members. Access is denied.
        YOUR_IMPERIAL_STANDING        = 7932, -- Your Imperial Standing has increased!
        YOU_MUST_BRING                = 8392, -- You must bring %.
        ...
        MEMBER_TOO_FAR                = 8490, -- One or more party members are too far away from the entrance. Unable to enter area.
        MEDUSA_ENGAGE                 = 8600, -- Foolish two-legs... Have you forgotten the terrible power of the gorgons you created? It is time you were reminded...
        MEDUSA_DEATH                  = 8601, -- No... I cannot leave my sisters...
        FOREBODING                    = 8603, -- You feel an eerie sense of foreboding...
        GLITTERING_FRAGMENTS          = 8924, -- Minute glittering fragments are scattered all over...
        STIFLING_STENCH               = 8937, -- A stifling stench pervades the air...
        SLIMY_TOUCH                   = 8942, -- The ground here is slimy to the touch...
        FLUTTERY_OBJECTS              = 8948, -- Light, fluttery objects litter the ground...
        DRAWS_NEAR                    = 8953, -- Something draws near!
