...
zones[xi.zone.GRAUBERG_S] =
{
    text =
    {
        ...
        SUITABLE_PLACE_TO_SOAK        = 8284, -- This seems to be a suitable place to soak <item>.
        MYSTERIOUS_COLUMN_ROTATES     = 8387, -- A mysterious column of floating stones rotates hypnotically before you.
        YOU_HAVE_RETRACED_RIVER       = 8412, -- You have retraced the river of memories back to the mission "Maiden of the Dusk".
        AIR_WARPED_AND_DISTORTED      = 8413, -- The air before you appears warped and distorted...
