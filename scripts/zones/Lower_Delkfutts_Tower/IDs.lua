...
zones[xi.zone.LOWER_DELKFUTTS_TOWER] =
{
    text =
    {
        ...
        SOMETHING_HUGE_BEARING_DOWN      = 7510,  -- Something huge is bearing down upon you!
        PLAYER_OBTAINS_ITEM              = 8645,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM            = 8646,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM         = 8647,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP             = 8648,  -- You already possess that temporary item.
        NO_COMBINATION                   = 8653,  -- You were unable to enter a combination.
        REGIME_REGISTERED                = 10731, -- New training regime registered!
        LEARNS_SPELL                     = 11779, -- <name> learns <spell>!
        UNCANNY_SENSATION                = 11781, -- You are assaulted by an uncanny sensation.
