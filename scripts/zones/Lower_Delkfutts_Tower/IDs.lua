...
zones[xi.zone.LOWER_DELKFUTTS_TOWER] =
{
    text =
    {
        ...
        SOMETHING_HUGE_BEARING_DOWN      = 7511,  -- Something huge is bearing down upon you!
        PLAYER_OBTAINS_ITEM              = 8646,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM            = 8647,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM         = 8648,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP             = 8649,  -- You already possess that temporary item.
        NO_COMBINATION                   = 8654,  -- You were unable to enter a combination.
        REGIME_REGISTERED                = 10732, -- New training regime registered!
        LEARNS_SPELL                     = 11780, -- <name> learns <spell>!
        UNCANNY_SENSATION                = 11782, -- You are assaulted by an uncanny sensation.
        COMMON_SENSE_SURVIVAL            = 11789, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
        {
