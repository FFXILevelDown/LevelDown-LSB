...
zones[xi.zone.EMPYREAL_PARADOX] =
{
    text =
    {
        ...
        PRISHE_TEXT                   = 7711, -- You're about to learn how strong the will to live makes us!
        SELHTEUS_TEXT                 = 7724, -- The...Emptiness... Is this...how it was meant...to be...?
        PROMATHIA_TEXT                = 7727, -- Give thyself to the apathy within...
        AIR_WARPED_AND_DISTORTED      = 7825, -- The air before you appears warped and distorted...
    },
    mob =
        {
