...
zones[xi.zone.ARRAPAGO_REMNANTS] =
{
    text =
    {
        ...
        TIME_REMAINING_MINUTES        = 7466, -- Time remaining: <number> [minute/minutes] (Earth time).
        TIME_REMAINING_SECONDS        = 7467, -- Time remaining: <number> [second/seconds] (Earth time).
