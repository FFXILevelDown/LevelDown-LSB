...
zones[xi.zone.ARRAPAGO_REMNANTS] =
{
    text =
    {
        ...
        TIME_TO_COMPLETE              = 7462, -- You have <number> [minute/minutes] (Earth time) to complete this mission.
        MISSION_FAILED                = 7463, -- The mission has failed. Leaving area.
        TIME_REMAINING_MINUTES        = 7467, -- Time remaining: <number> [minute/minutes] (Earth time).
        TIME_REMAINING_SECONDS        = 7468, -- Time remaining: <number> [second/seconds] (Earth time).
        PARTY_FALLEN                  = 7470, -- All party members have fallen in battle. Mission failure in <number> [minute/minutes].
        DOOR_IS_SEALED                = 7481, -- The door is sealed...
        DOOR_IS_SEALED_MYSTERIOUS     = 7484, -- The door is sealed by some mysterious force...
    },
    mob =
        {
            [1] =
