...
zones[xi.zone.SAUROMUGUE_CHAMPAIGN] =
{
    text =
    {
        ...
        MANY_TIGER_BONES              = 7253,  -- There are many tiger bones here...
        OLD_SABERTOOTH_DIALOG_I       = 7259,  -- You hear the distant roar of a tiger. It sounds as if the beast is approaching slowly...
        OLD_SABERTOOTH_DIALOG_II      = 7260,  -- The sound of the tiger's footsteps is growing louder.
        ...
        FOUND_ITEM_WITH_EASE          = 7351,  -- It appears your chocobo found this item with ease.
        THF_AF_MOB                    = 7439,  -- Something has come down from the tower!
        THF_AF_WALL_OFFSET            = 7458,  -- It is impossible to climb this wall with your bare hands.
        ...
        TIME_ELAPSED                  = 7673,  -- Time elapsed: <number> [hour/hours] (Vana'diel time) <number> [minute/minutes] and <number> [second/seconds] (Earth time)
        ...
        LEARNS_SPELL                  = 12511, -- <name> learns <spell>!
        UNCANNY_SENSATION             = 12513, -- You are assaulted by an uncanny sensation.
