...
zones[xi.zone.INNER_HORUTOTO_RUINS] =
{
    text =
    {
        ...
        ITEM_CANNOT_BE_OBTAINED       = 6556,  -- You cannot obtain the <item>. Come back after sorting your inventory.
        ITEM_OBTAINED                 = 6564,  -- Obtained: <item>.
        GIL_OBTAINED                  = 6565,  -- Obtained <number> gil.
        KEYITEM_OBTAINED              = 6567,  -- Obtained key item: <keyitem>.
        FELLOW_MESSAGE_OFFSET         = 6593,  -- I'm ready. I suppose.
        ...
        GEOMAGNETRON_ATTUNED          = 7186,  -- Your <keyitem> has been attuned to a geomagnetic fount in the corresponding locale.
        MEMBERS_LEVELS_ARE_RESTRICTED = 7197,  -- Your party is unable to participate because certain members' levels are restricted.
        NOT_BROKEN_ORB                = 7258,  -- The Mana Orb in this receptacle is not broken.
        EXAMINED_RECEPTACLE           = 7259,  -- You have already examined this receptacle.
        DOOR_FIRMLY_CLOSED            = 7286,  -- The door is firmly closed.
        CAT_BURGLARS_HIDEOUT          = 7287,  -- It looks like that Cat Burglar's hideout lies behind this door! You were able to confirm <keyitem>!
