...
zones[xi.zone.HAZHALM_TESTING_GROUNDS] =
{
    text =
    {
        ...
        OBTAINS_TEMP_ITEM             = 7070, -- Obtained temporary item: <item>.
        GATE_FIRMLY_CLOSED            = 7232, -- The gate is firmly closed...
        PARTY_MEMBERS_HAVE_FALLEN     = 7617, -- All party members have fallen in battle. Now leaving the battlefield.
        THE_PARTY_WILL_BE_REMOVED     = 7624, -- If all party members' HP are still zero after # minute[/s], the party will be removed from the battlefield.
        ALREADY_POSSESS_TEMP          = 8000, -- You already have that temporary item.
        STAGNANT_AURA_CLEARED         = 8001, -- The chamber's stagnant aura has somewhat cleared...
        CREATURES_CALMED              = 8002, -- The creatures lurking in the shadows have calmed...
        CREATURES_RESTLESS            = 8003, -- The creatures lurking in the shadows have become restless...
        DENDAINSONNE_ANGRY            = 8008, -- Dendainsonne looks angry...
        DENDAINSONNE_ENRAGED          = 8009, -- Dendainsonne is enraged!
        DENDAINSONNE_OUT_OF_CONTROL   = 8010, -- Dendainsonne is out of control!
        DENDAINSONNE_MOCKING_YOU      = 8011, -- Dendainsonne appears to be mocking you...
        OTHERWORLDLY_VOICE            = 8048, -- An otherworldly voice echoes faintly from the depths of your skull...
        PROVE_THY_WORTH               = 8049, -- ...who would...prove...thy...worth... Deliver...unto me...and speak...my name...
        FEATHERS_CONSUMED             = 8059, -- All of the valkyrie feathers in your possession are consumed!
        ENTRY_PROHIBITED              = 8060, -- Entry to the chambers is prohibited for # more Vana'dielian [day/days].
        MIN_LEVEL_ENTRY               = 8061, -- Adventurers who have yet to reach level <number> will not be permitted entry to the training grounds.
        RESERVATION_LOCKOUT           = 8062, -- Chamber reservation is prohibited for # more Vana'dielian [day/days].
        MIN_LEVEL_RESERVATION         = 8063, -- Adventurers who have yet to reach level <number> will not be permitted to make reservations within the training grounds.
        COULD_NOT_GATHER_DATA         = 8065, -- Could not gather the sufficient data.
        CHAMBER_OCCUPIED              = 8067, -- Currently, another expedition is occupying [/Rossweisse's Chamber/Grimgerde's Chamber/Siegrune's Chamber/Helmwige's Chamber/Schwertleite's Chamber/Waltraute's Chamber/Ortlinde's Chamber/Gerhilde's Chamber/Brunhilde's Chamber/Odin's Chamber/Odin's Chamber].
        GLOWING_LAMP_OBTAINED         = 8068, -- Time and destination have been recorded on your <item>.
        MISSING_FEATHERS              = 8069, -- You do not possess the items required for entry.
        REQUIREMENTS_UNMET            = 8070, -- You do not meet the requirements for entry.
        LAMP_POWER_FADED              = 8071, -- The power of the % has faded. You may no longer occupy this chamber.
        TOO_MANY_ADVENTURERS          = 8073, -- There are too many adventurers in the chamber.
        TIMEOUT_WARNING               = 8074, -- ----== Warning! ==---- Your reservation of this chamber will end in <number> [minute/minutes].
        TIMEOUT_WARNING_SECONDS       = 8075, -- ----== Warning! ==---- Your reservation of this chamber will end in <number> [second/seconds].
        EXPEDITION_INCAPACITATED_WARN = 8076, -- All expedition members have been incapacitated. Commencing emergency teleportation in # [minute/minutes].
        EXPEDITION_INCAPACITATED      = 8077, -- All expedition members have been incapacitated. Commencing emergency teleportation.
        CHAMBER_CLEARED               = 8080, -- [Rossweisse's Chamber/Grimgerde's Chamber/Siegrune's Chamber/Helmwige's Chamber/Schwertleite's Chamber/Waltraute's Chamber/Ortlinde's Chamber/Gerhilde's Chamber/Brunhilde's Chamber/Odin's Chamber/Odin's Chamber] has been cleared. Commencing teleportation in # [minute/minutes].
        MEMBERS_ENGAGED_IN_BATTLE     = 8081, -- Other members currently engaged in battle. Entry denied.
        AMPOULES_OBTAINED             = 8082, -- You obtain <number> ampoule[/s] of viscous therion ichor.
        GROUP_LEADER_NOT_YET_ENTERED  = 8083, -- The group leader has not yet entered the chamber. Entry denied.
        CLAIM_RELINQUISH              = 8085, -- Note that your claim over the area through your <item> will be relinquished if over <number> more minute[/s] pass from this point with no one inside.
    },
    mob =
        {
