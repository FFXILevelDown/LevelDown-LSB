...
zones[xi.zone.HAZHALM_TESTING_GROUNDS] =
{
    text =
    {
        ...
        OBTAINS_TEMP_ITEM             = 7069, -- Obtained temporary item: <item>.
        GATE_FIRMLY_CLOSED            = 7231, -- The gate is firmly closed...
        PARTY_MEMBERS_HAVE_FALLEN     = 7616, -- All party members have fallen in battle. Now leaving the battlefield.
        THE_PARTY_WILL_BE_REMOVED     = 7623, -- If all party members' HP are still zero after # minute[/s], the party will be removed from the battlefield.
        ALREADY_POSSESS_TEMP          = 7999, -- You already have that temporary item.
        STAGNANT_AURA_CLEARED         = 8000, -- The chamber's stagnant aura has somewhat cleared...
        CREATURES_CALMED              = 8001, -- The creatures lurking in the shadows have calmed...
        CREATURES_RESTLESS            = 8002, -- The creatures lurking in the shadows have become restless...
        DENDAINSONNE_ANGRY            = 8007, -- Dendainsonne looks angry...
        DENDAINSONNE_ENRAGED          = 8008, -- Dendainsonne is enraged!
        DENDAINSONNE_OUT_OF_CONTROL   = 8009, -- Dendainsonne is out of control!
        DENDAINSONNE_MOCKING_YOU      = 8010, -- Dendainsonne appears to be mocking you...
        OTHERWORLDLY_VOICE            = 8047, -- An otherworldly voice echoes faintly from the depths of your skull...
        PROVE_THY_WORTH               = 8048, -- ...who would...prove...thy...worth... Deliver...unto me...and speak...my name...
        FEATHERS_CONSUMED             = 8058, -- All of the valkyrie feathers in your possession are consumed!
        ENTRY_PROHIBITED              = 8059, -- Entry to the chambers is prohibited for # more Vana'dielian [day/days].
        MIN_LEVEL_ENTRY               = 8060, -- Adventurers who have yet to reach level <number> will not be permitted entry to the training grounds.
        RESERVATION_LOCKOUT           = 8061, -- Chamber reservation is prohibited for # more Vana'dielian [day/days].
        MIN_LEVEL_RESERVATION         = 8062, -- Adventurers who have yet to reach level <number> will not be permitted to make reservations within the training grounds.
        COULD_NOT_GATHER_DATA         = 8064, -- Could not gather the sufficient data.
        CHAMBER_OCCUPIED              = 8066, -- Currently, another expedition is occupying [/Rossweisse's Chamber/Grimgerde's Chamber/Siegrune's Chamber/Helmwige's Chamber/Schwertleite's Chamber/Waltraute's Chamber/Ortlinde's Chamber/Gerhilde's Chamber/Brunhilde's Chamber/Odin's Chamber/Odin's Chamber].
        GLOWING_LAMP_OBTAINED         = 8067, -- Time and destination have been recorded on your <item>.
        MISSING_FEATHERS              = 8068, -- You do not possess the items required for entry.
        REQUIREMENTS_UNMET            = 8069, -- You do not meet the requirements for entry.
        LAMP_POWER_FADED              = 8070, -- The power of the % has faded. You may no longer occupy this chamber.
        TOO_MANY_ADVENTURERS          = 8072, -- There are too many adventurers in the chamber.
        TIMEOUT_WARNING               = 8073, -- ----== Warning! ==---- Your reservation of this chamber will end in <number> [minute/minutes].
        TIMEOUT_WARNING_SECONDS       = 8074, -- ----== Warning! ==---- Your reservation of this chamber will end in <number> [second/seconds].
        EXPEDITION_INCAPACITATED_WARN = 8075, -- All expedition members have been incapacitated. Commencing emergency teleportation in # [minute/minutes].
        EXPEDITION_INCAPACITATED      = 8076, -- All expedition members have been incapacitated. Commencing emergency teleportation.
        CHAMBER_CLEARED               = 8079, -- [Rossweisse's Chamber/Grimgerde's Chamber/Siegrune's Chamber/Helmwige's Chamber/Schwertleite's Chamber/Waltraute's Chamber/Ortlinde's Chamber/Gerhilde's Chamber/Brunhilde's Chamber/Odin's Chamber/Odin's Chamber] has been cleared. Commencing teleportation in # [minute/minutes].
        MEMBERS_ENGAGED_IN_BATTLE     = 8080, -- Other members currently engaged in battle. Entry denied.
        AMPOULES_OBTAINED             = 8081, -- You obtain <number> ampoule[/s] of viscous therion ichor.
        GROUP_LEADER_NOT_YET_ENTERED  = 8082, -- The group leader has not yet entered the chamber. Entry denied.
        CLAIM_RELINQUISH              = 8084, -- Note that your claim over the area through your <item> will be relinquished if over <number> more minute[/s] pass from this point with no one inside.
    },
    mob =
        {
