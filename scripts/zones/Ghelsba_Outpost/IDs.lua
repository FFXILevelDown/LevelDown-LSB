...
zones[xi.zone.GHELSBA_OUTPOST] =
{
    text =
    {
        ...
        ITEM_CANNOT_BE_OBTAINED          = 6919, -- You cannot obtain the <item>. Come back after sorting your inventory.
        ITEM_OBTAINED                    = 6927, -- Obtained: <item>.
        GIL_OBTAINED                     = 6928, -- Obtained <number> gil.
        KEYITEM_OBTAINED                 = 6930, -- Obtained key item: <keyitem>.
        NOTHING_OUT_OF_ORDINARY          = 6941, -- There is nothing out of the ordinary here.
        FELLOW_MESSAGE_OFFSET            = 6956, -- I'm ready. I suppose.
        CARRIED_OVER_POINTS              = 7538, -- You have carried over <number> login point[/s].
        LOGIN_CAMPAIGN_UNDERWAY          = 7539, -- The [/January/February/March/April/May/June/July/August/September/October/November/December] <number> Login Campaign is currently underway!
        LOGIN_NUMBER                     = 7540, -- In celebration of your most recent login (login no. <number>), we have provided you with <number> points! You currently have a total of <number> points.
        MEMBERS_LEVELS_ARE_RESTRICTED    = 7560, -- Your party is unable to participate because certain members' levels are restricted.
        FISHING_MESSAGE_OFFSET           = 7605, -- You can't fish here.
        NO_BATTLEFIELD_ENTRY             = 7740, -- This looks like an Orcish dwelling. The door is firmly shut.
        ENTERING_THE_BATTLEFIELD_FOR     = 7765, -- Entering the battlefield for [Save the Children/The Holy Crest/Wings of Fury/Petrifying Pair/Toadal Recall/Mirror, Mirror]!
        LOGGING_IS_POSSIBLE_HERE         = 7767, -- Logging is possible here if you have <item>.
        YOU_CAN_NOW_BECOME_A_DRAGOON     = 7807, -- You can now become a dragoon!
    },
    mob =
        {
