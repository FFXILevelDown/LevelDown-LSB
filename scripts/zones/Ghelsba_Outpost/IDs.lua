...
zones[xi.zone.GHELSBA_OUTPOST] =
{
    text =
    {
        ...
        ITEM_CANNOT_BE_OBTAINED          = 6918, -- You cannot obtain the <item>. Come back after sorting your inventory.
        ITEM_OBTAINED                    = 6926, -- Obtained: <item>.
        GIL_OBTAINED                     = 6927, -- Obtained <number> gil.
        KEYITEM_OBTAINED                 = 6929, -- Obtained key item: <keyitem>.
        NOTHING_OUT_OF_ORDINARY          = 6940, -- There is nothing out of the ordinary here.
        FELLOW_MESSAGE_OFFSET            = 6955, -- I'm ready. I suppose.
        CARRIED_OVER_POINTS              = 7537, -- You have carried over <number> login point[/s].
        LOGIN_CAMPAIGN_UNDERWAY          = 7538, -- The [/January/February/March/April/May/June/July/August/September/October/November/December] <number> Login Campaign is currently underway!
        LOGIN_NUMBER                     = 7539, -- In celebration of your most recent login (login no. <number>), we have provided you with <number> points! You currently have a total of <number> points.
        MEMBERS_LEVELS_ARE_RESTRICTED    = 7559, -- Your party is unable to participate because certain members' levels are restricted.
        FISHING_MESSAGE_OFFSET           = 7604, -- You can't fish here.
        NO_BATTLEFIELD_ENTRY             = 7739, -- This looks like an Orcish dwelling. The door is firmly shut.
        ENTERING_THE_BATTLEFIELD_FOR     = 7764, -- Entering the battlefield for [Save the Children/The Holy Crest/Wings of Fury/Petrifying Pair/Toadal Recall/Mirror, Mirror]!
        LOGGING_IS_POSSIBLE_HERE         = 7766, -- Logging is possible here if you have <item>.
