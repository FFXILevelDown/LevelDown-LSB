...
zones[xi.zone.ROMAEVE] =
{
    text =
    {
        ...
        PILE_OF_RUBBLE                = 7414,  -- It is nothing but a pile of rubble.
        A_CHILL_RUNS_DOWN_SPINE       = 7415,  -- A chill runs down your spine.
        ...
        PLAYER_OBTAINS_ITEM           = 7450,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 7451,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 7452,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 7453,  -- You already possess that temporary item.
        NO_COMBINATION                = 7458,  -- You were unable to enter a combination.
        UNITY_WANTED_BATTLE_INTERACT  = 7520,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
