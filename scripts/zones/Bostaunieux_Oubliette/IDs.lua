...
zones[xi.zone.BOSTAUNIEUX_OUBLIETTE] =
{
    text =
    {
        ...
        CHUMIA_DIALOG                 = 7332,  -- Welcome to Bostaunieux Oubliette...
        SEEMS_LOCKED                  = 7334,  -- It seems to be locked.
        SPIRAL_HELL_LEARNED           = 7441,  -- You have learned the weapon skill Spiral Hell!
        SENSE_OMINOUS_PRESENCE        = 7442,  -- You sense an ominous presence...
        ITEMS_ITEMS_LA_LA             = 7445,  -- You can hear a strange voice... Items, items, la la la la la
        GOBLIN_SLIPPED_AWAY           = 7451,  -- The Goblin slipped away when you were not looking...
        REGIME_REGISTERED             = 9556,  -- New training regime registered!
        PLAYER_OBTAINS_ITEM           = 10608, -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 10609, -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 10610, -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 10611, -- You already possess that temporary item.
        NO_COMBINATION                = 10616, -- You were unable to enter a combination.
        LEARNS_SPELL                  = 10640, -- <name> learns <spell>!
        UNCANNY_SENSATION             = 10642, -- You are assaulted by an uncanny sensation.
        COMMON_SENSE_SURVIVAL         = 10649, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
