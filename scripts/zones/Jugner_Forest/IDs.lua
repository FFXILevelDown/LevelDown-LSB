...
zones[xi.zone.JUGNER_FOREST] =
{
    text =
    {
        ...
        DIG_THROW_AWAY                = 7741,  -- You dig up <item>, but your inventory is full. You regretfully throw the <item> away.
        ...
        DUG_UP                        = 8033,  -- Something was dug up here...
        UNABLE_TO_INVESTIGATE         = 8034,  -- For some reason, you are unable to investigate this spot. There is a preternatural force at work here...
        SENSE_OF_FOREBODING           = 8035,  -- A sense of foreboding fills the air...
        CONQUEST                      = 8073,  -- You've earned conquest points!
        GARRISON_BASE                 = 8441,  -- Hm? What is this? %? How do I know this is not some [San d'Orian/Bastokan/Windurstian] trick?
        ...
        PLAYER_OBTAINS_ITEM           = 8664,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 8665,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 8666,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 8667,  -- You already possess that temporary item.
        NO_COMBINATION                = 8672,  -- You were unable to enter a combination.
        VOIDWALKER_DESPAWN            = 8703,  -- The monster fades before your eyes, a look of disappointment on its face.
        UNITY_WANTED_BATTLE_INTERACT  = 8734,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        REGIME_REGISTERED             = 10877, -- New training regime registered!
        DRAWN_UNWANTED_ATTENTION      = 11931, -- Your presence has drawn unwanted attention!
        SENSE_UNUSUAL_PRESENCE        = 11933, -- You sense an unusual presence in the area...
        ...
        VOIDWALKER_SPAWN_MOB          = 12098, -- A monster materializes out of nowhere!
