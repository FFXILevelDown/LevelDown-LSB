...
zones[xi.zone.BALGAS_DAIS] =
{
    text =
    {
        ...
        ENTERING_THE_BATTLEFIELD_FOR  = 7609, -- Entering the battlefield for [The Rank 2 Final Mission/Steamed Sprouts/Divine Punishers/Saintly Invitation/Treasure and Tribulations/Shattering Stars (MNK)/Shattering Stars (WHM)/Shattering Stars (SMN)/Creeping Doom/Charming Trio/Harem Scarem/Early Bird Catches the Wyrm/Royal Succession/Rapid Raptors/Wild Wild Whiskers/Seasons Greetings/Royale Ramble/Moa Constrictors/The V Formation/Avian Apostates/Beyond Infinity/★Steamed Sprouts/★Divine Punishers/A Feast Most Dire/A.M.A.N. Trove (Mars)/A.M.A.N. Trove (Venus)/Inv. from Kupipi/Inv. from Kupipi and Co.]!
        YOU_DECIDED_TO_SHOW_UP        = 7655, -- So, you decided to show up. Now it's time to see what you're really made of, heh heh heh.
        LOOKS_LIKE_YOU_WERENT_READY   = 7656, -- Looks like you weren't ready for me, were you? Now go home, wash your face, and come back when you think you've got what it takes.
        YOUVE_COME_A_LONG_WAY         = 7657, -- Hm. That was a mighty fine display of skill there, <name>. You've come a long way...
        TEACH_YOU_TO_RESPECT_ELDERS   = 7658, -- I'll teach you to respect your elders!
        TAKE_THAT_YOU_WHIPPERSNAPPER  = 7659, -- Take that, you whippersnapper!
        NOW_THAT_IM_WARMED_UP         = 7660, -- Now that I'm warmed up...
        THAT_LL_HURT_IN_THE_MORNING   = 7661, -- Ungh... That'll hurt in the morning...
        WILD_WILD_WHISKERS_OFFSET     = 7679, -- Macan Gadangan's whiskers begin to twitch slightly.
        SOUL_GEM_REACTS               = 7684, -- The <keyitem> reacts to the <keyitem>, sending a jolt of energy through your veins!
        PROMISE_ME_YOU_WONT_GO_DOWN   = 7699, -- Promise you won't go down too easy, okay?
        IM_JUST_GETTING_WARMED_UP     = 7700, -- Haha! I'm just getting warmed up!
        YOU_PACKED_MORE_OF_A_PUNCH    = 7701, -- Hah! You pack more of a punch than I thoughtaru. But I won't go down as easy as old Maat!
        WHATS_THIS_STRANGE_FEELING    = 7702, -- What's this strange feeling...? It's not supposed to end...like...
        HUH_IS_THAT_ALL               = 7703, -- Huh? Is that all? I haven't even broken a sweataru...
        YIKEY_WIKEYS                  = 7704, -- Yikey-wikeys! Get that thing away from meee!
