...
zones[xi.zone.VELUGANNON_PALACE] =
{
    text =
    {
        ...
        ITEM_CANNOT_BE_OBTAINED_TRADE = 6391,  -- You cannot obtain the <item>. Try trading again after sorting your inventory.
        ...
        EVIL_PRESENCE                 = 7250,  -- You sense an evil presence lurking in the shadows...
        KNIFE_CHANGES_SHAPE           = 7257,  -- The <item> begins to change shape.
        NOTHING_HAPPENS               = 7258,  -- Nothing happens.
        REGIME_REGISTERED             = 10183, -- New training regime registered!
        PLAYER_OBTAINS_ITEM           = 11235, -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 11236, -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 11237, -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 11238, -- You already possess that temporary item.
        NO_COMBINATION                = 11243, -- You were unable to enter a combination.
    },
    mob =
        {
