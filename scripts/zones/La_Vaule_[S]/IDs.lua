...
zones[xi.zone.LA_VAULE_S] =
{
    text =
    {
        ...
        MEMBERS_OF_YOUR_ALLIANCE      = 8008, -- Currently, # members of your alliance (including yourself) have clearance to enter the battlefield.
        TIME_LIMIT_FOR_THIS_BATTLE_IS = 8010, -- The time limit for this battle is <number> minutes.
        ...
        ENTERING_THE_BATTLEFIELD_FOR  = 8075, -- Entering the battlefield for [Splitting Heirs (S)/Purple, The New Black/The Blood-bathed Crown]!
        GATHERED_DAWNDROPS_LIGHT      = 8361, -- The gathered dawndrops unleash a brilliant light, melding together to form <keyitem>!
        RETRACED_ALL_JUNCTIONS        = 8362, -- You have retraced all junctions of eventualities. Hasten back to where Cait Sith and Lilisette await.
    },
    mob =
        {
