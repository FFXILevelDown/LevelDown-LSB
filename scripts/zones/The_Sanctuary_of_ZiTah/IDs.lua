...
zones[xi.zone.THE_SANCTUARY_OF_ZITAH] =
{
    text =
    {
        ...
        AIR_HAS_SUDDENLY_CHANGED      = 7756,  -- The air around you has suddenly changed!
        SOMETHING_BETTER              = 7757,  -- Don't you have something better to do right now?
        CANNOT_REMOVE_FRAG            = 7760,  -- It is an oddly shaped stone monument. A shining stone is embedded in it, but cannot be removed...
        ALREADY_OBTAINED_FRAG         = 7761,  -- You have already obtained this monument's <keyitem>. Try searching for another.
        FOUND_ALL_FRAGS               = 7763,  -- You have obtained <keyitem>! You now have all 8 fragments of light!
        ZILART_MONUMENT               = 7764,  -- It is an ancient Zilart monument.
        AIR_REMAINS_STAGNANT          = 7776,  -- The air in this area remains stagnant. You begin to feel sick... It would be wise to leave immediately.
        LOOKS_LIKE_STURDY_BRANCH      = 7786,  -- This looks like a sturdy branch. You will need <item> to cut it off.
        BEAUTIFUL_STURDY_BRANCH       = 7787,  -- It is a beautiful, sturdy branch.
        SENSE_STRONG_EVIL_PRESENCE    = 7789,  -- You can sense a strong, evil presence!
        STRANGE_FORCE_PREVENTS        = 7790,  -- Some strange force is preventing you from cutting all the way through.
        STRANGE_FORCE_VANISHED        = 7791,  -- The strange force has vanished, and <item> has newly sprouted in the cut!
        NO_LONGER_SENSE_EVIL          = 7792,  -- You no longer sense the evil presence, but there is still a feeling of unrest throughout the forest.
        NEWLY_SPROUTED_GLOWING        = 7793,  -- The newly sprouted <item> is glowing softly. You no longer feel as if you are being watched.
        NOT_THE_TIME_FOR_THAT         = 7794,  -- This is not the time for that!
        SENSE_OMINOUS_PRESENCE        = 7867,  -- You sense an ominous presence...
        GARRISON_BASE                 = 8054,  -- Hm? What is this? %? How do I know this is not some [San d'Orian/Bastokan/Windurstian] trick?
        PLAYER_OBTAINS_ITEM           = 8101,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 8102,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 8103,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 8104,  -- You already possess that temporary item.
        NO_COMBINATION                = 8109,  -- You were unable to enter a combination.
        UNITY_WANTED_BATTLE_INTERACT  = 8171,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
