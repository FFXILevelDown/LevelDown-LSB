...
zones[xi.zone.THE_SANCTUARY_OF_ZITAH] =
{
    text =
    {
        ...
        STRANGE_FORCE_PREVENTS        = 7791,  -- Some strange force is preventing you from cutting all the way through.
        STRANGE_FORCE_VANISHED        = 7792,  -- The strange force has vanished, and <item> has newly sprouted in the cut!
        NO_LONGER_SENSE_EVIL          = 7793,  -- You no longer sense the evil presence, but there is still a feeling of unrest throughout the forest.
        NEWLY_SPROUTED_GLOWING        = 7794,  -- The newly sprouted <item> is glowing softly. You no longer feel as if you are being watched.
        NOT_THE_TIME_FOR_THAT         = 7795,  -- This is not the time for that!
        SENSE_OMINOUS_PRESENCE        = 7868,  -- You sense an ominous presence...
        GARRISON_BASE                 = 8055,  -- Hm? What is this? %? How do I know this is not some [San d'Orian/Bastokan/Windurstian] trick?
        PLAYER_OBTAINS_ITEM           = 8102,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 8103,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 8104,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 8105,  -- You already possess that temporary item.
        NO_COMBINATION                = 8110,  -- You were unable to enter a combination.
        UNITY_WANTED_BATTLE_INTERACT  = 8172,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
