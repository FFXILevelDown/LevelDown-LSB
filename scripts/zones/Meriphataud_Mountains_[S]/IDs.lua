...
zones[xi.zone.MERIPHATAUD_MOUNTAINS_S] =
{
    text =
    {
        ...
        VOIDWALKER_MOB_HINT           = 7934, -- The <keyitem> resonates [feebly/softly/solidly/strongly/very strongly/furiously], sending a radiant beam of light lancing towards a spot roughly <number> [yalm/yalms] [east/southeast/south/southwest/west/northwest/north/northeast] of here.
        VOIDWALKER_SPAWN_MOB          = 7935, -- A monster materializes out of nowhere!
        VOIDWALKER_UPGRADE_KI_1       = 7937, -- The <keyitem> takes on a slightly deeper hue and becomes <keyitem>!
        VOIDWALKER_UPGRADE_KI_2       = 7938, -- The <keyitem> takes on a deeper, richer hue and becomes <keyitem>!
        VOIDWALKER_BREAK_KI           = 7939, -- The <keyitem> shatters into tiny fragments.
        VOIDWALKER_OBTAIN_KI          = 7940, -- Obtained key item: <keyitem>!
