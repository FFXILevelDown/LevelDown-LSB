...
zones[xi.zone.ULEGUERAND_RANGE] =
{
    text =
    {
        ...
        GEUSH_COUNTER                 = 7415, -- Geush Urvan uses Counterstance!
        FRESH_RABBIT_TRACKS           = 7417, -- There are fresh rabbit tracks here. The creature must still be in the vicinity.
        HOMEPOINT_SET                 = 8352, -- Home point set!
        UNITY_WANTED_BATTLE_INTERACT  = 8410, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
    },
    mob =
        {
