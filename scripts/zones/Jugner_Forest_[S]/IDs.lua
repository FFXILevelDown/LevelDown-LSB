...
zones[xi.zone.JUGNER_FOREST_S] =
{
    text =
    {
        ...
        LOGGING_IS_POSSIBLE_HERE      = 7093, -- Logging is possible here if you have <item>.
        ...
        LILISETTE_IS_PREPARING        = 8417, -- Lilisette is preparing a new trap in an attempt to catch the ever-elusive Cait Sith. Bring her <item> to use as bait.
        IDEAL_PLACE_TO_PLANT_ITEM     = 8546, -- This seems to be an ideal place to plant <item>.
        YOU_PLANT_ITEM                = 8547, -- You plant <item>.
        ITEM_IS_PLANTED_HERE          = 8548, -- <item> has been planted here...
        NO_RESPONSE                   = 8552, -- There is no response...
        VOIDWALKER_DESPAWN            = 8575, -- The monster fades before your eyes, a look of disappointment on its face.
        ...
        VOIDWALKER_SPAWN_MOB          = 8625, -- A monster materializes out of nowhere!
        ...
        RETRACED_ALL_JUNCTIONS        = 8651, -- You have retraced all junctions of eventualities. Hasten back to where Cait Sith and Lilisette await.
