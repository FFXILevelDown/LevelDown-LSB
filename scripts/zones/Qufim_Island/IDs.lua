...
zones[xi.zone.QUFIM_ISLAND] =
{
    text =
    {
        ...
        WAIT_A_BIT_LONGER              = 6411,  -- It seems that you will have to wait a bit longer...
        ...
        NOW_THAT_NIGHT_HAS_FALLEN      = 7353,  -- Now that night has fallen, the flowers bloom with a strange glow.
        ...
        GIGANTIC_FOOTPRINT             = 7844,  -- There is a gigantic footprint here.
        ASA_SNOW                       = 7857,  -- You see the following words scrawled into the snow: Shantotto Empire Provisional Headquarters.
        YOU_CANNOT_ENTER_DYNAMIS       = 7870,  -- You cannot enter Dynamis - [Dummy/San d'Oria/Bastok/Windurst/Jeuno/Beaucedine/Xarcabard/Valkurm/Buburimu/Qufim/Tavnazia] for <number> [day/days] (Vana'diel time).
        PLAYERS_HAVE_NOT_REACHED_LEVEL = 7872,  -- Players who have not reached level <number> are prohibited from entering Dynamis.
        DYNA_NPC_DEFAULT_MESSAGE       = 7994,  -- There is a strange symbol drawn here. A haunting chill sweeps through you as you gaze upon it...
        ...
        UNITY_WANTED_BATTLE_INTERACT   = 8138,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        REGIME_REGISTERED              = 10352, -- New training regime registered!
        LEARNS_SPELL                   = 12670, -- <name> learns <spell>!
        UNCANNY_SENSATION              = 12672, -- You are assaulted by an uncanny sensation.
        COMMON_SENSE_SURVIVAL          = 12679, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
