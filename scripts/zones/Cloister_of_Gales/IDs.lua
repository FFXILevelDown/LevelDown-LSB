...
zones[xi.zone.CLOISTER_OF_GALES] =
{
    text =
    {
        ...
        GARUDA_UNLOCKED                  = 7591, -- You are now able to summon [Ifrit/Titan/Leviathan/Garuda/Shiva/Ramuh].
        ENTERING_THE_BATTLEFIELD_FOR     = 7679, -- Entering the battlefield for [Trial by Wind/Carbuncle Debacle/Trial-Size Trial by Wind/Waking the Beast/Sugar-coated Directive/★Trial by Wind]!
        ATTACH_SEAL                      = 7775, -- <player> attaches <item> to the protocrystal.
