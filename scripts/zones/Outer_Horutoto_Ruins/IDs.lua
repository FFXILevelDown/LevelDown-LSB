...
zones[xi.zone.OUTER_HORUTOTO_RUINS] =
{
    text =
    {
        ...
        ITEM_OBTAINED                 = 6600,  -- Obtained: <item>.
        GIL_OBTAINED                  = 6601,  -- Obtained <number> gil.
        KEYITEM_OBTAINED              = 6603,  -- Obtained key item: <keyitem>.
        NOTHING_OUT_OF_ORDINARY       = 6614,  -- There is nothing out of the ordinary here.
        FELLOW_MESSAGE_OFFSET         = 6629,  -- I'm ready. I suppose.
        ...
        COMMENCING_EXPERIMENT         = 7367,  -- CoMM-eN-cInG★Ex-PE-rI-MeNt.
        INITIATING_TRANSMISSION       = 7368,  -- Da-TA★cO-LLeC-TiOn★COmP-LETe! INi-TiAT-iNG★TRAnS-miSS-IOn★TO★PRo-FeSS-oR...
        VENTURED_TOO_FAR              = 7369,  -- You have ventured too far from the field of battle. The Confrontation will automatically disengage if you do not return.
        CONFRONTATION_DISENGAGED      = 7370,  -- You have ventured too far from the field of battle. The Confrontation has been disengaged.
        RETURNED_TO_BATTLE            = 7371,  -- You have returned to the field of battle.
        YOU_HAVE_X_MINUTES_LEFT       = 7372,  -- You have <number> [minute/minutes] (Earth time) to complete the battle.
        YOU_HAVE_ONLY_X_SECONDS_LEFT  = 7374,  -- You have only <number> [second/seconds] (Earth time) remaining.
        CONFRONTATION_TIME_UP         = 7375,  -- Your time for this Confrontation is up...
