...
zones[xi.zone.CRAWLERS_NEST] =
{
    text =
    {
        ...
        ITEM_CANNOT_BE_OBTAINED       = 6577,  -- You cannot obtain the <item>. Come back after sorting your inventory.
        ITEM_OBTAINED                 = 6585,  -- Obtained: <item>.
        GIL_OBTAINED                  = 6586,  -- Obtained <number> gil.
        KEYITEM_OBTAINED              = 6588,  -- Obtained key item: <keyitem>.
        NOTHING_OUT_OF_ORDINARY       = 6599,  -- There is nothing out of the ordinary here.
        SENSE_OF_FOREBODING           = 6600,  -- You are suddenly overcome with a sense of foreboding...
        FELLOW_MESSAGE_OFFSET         = 6614,  -- I'm ready. I suppose.
        ...
        SOMEONE_HAS_BEEN_DIGGING_HERE = 7284,  -- Someone has been digging here.
        EQUIPMENT_NOT_PURIFIED        = 7285,  -- Your equipment has not been completely purified.
        YOU_BURY_THE                  = 7287,  -- You bury the <item> and <item>.
        NOTHING_WILL_HAPPEN_YET       = 7290,  -- It seems that nothing will happen yet.
        NOTHING_SEEMS_TO_HAPPEN       = 7291,  -- Nothing seems to happen.
