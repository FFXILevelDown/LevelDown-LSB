...
zones[xi.zone.RUAUN_GARDENS] =
{
    text =
    {
        ...
        ITEMS_ITEMS_LA_LA             = 7398,  -- You can hear a strange voice... Items, items, la la la la la
        GOBLIN_SLIPPED_AWAY           = 7404,  -- The Goblin slipped away when you were not looking...
