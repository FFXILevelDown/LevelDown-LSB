...
zones[xi.zone.KING_RANPERRES_TOMB] =
{
    text =
    {
        ...
        HERE_LIES_KING_RANPERRE       = 7270,  -- Here lies King Ranperre. May he rest in peace.
        NOTHING_HAPPENS               = 7272,  -- Nothing happens.
        CHANGE_WATER                  = 7273,  -- You change the water.
        WATER_ALREADY_CHANGED         = 7274,  -- The water has already been changed.
        ALREADY_WATER_HERE            = 7275,  -- There is already water here.
        WATERSKIN_LYING_HERE          = 7276,  -- A waterskin is lying here.
        CHEST_UNLOCKED                = 7303,  -- You unlock the chest!
        SENSE_SOMETHING_EVIL          = 7330,  -- You sense something evil.
        HEAVY_DOOR                    = 7331,  -- It is a solid stone door.
        FINAL_RESTING_PLACE           = 7335,  -- It appears to be the true resting place of King Ranperre.
