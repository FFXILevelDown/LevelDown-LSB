...
zones[xi.zone.KORROLOKA_TUNNEL] =
{
    text =
    {
        ...
        FLASK_FULL                    = 7358,  -- <item> is now full!
        CLAM_EMPTY                    = 7359,  -- The clam is empty.
        REGIME_REGISTERED             = 9481,  -- New training regime registered!
        PLAYER_OBTAINS_ITEM           = 10533, -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 10534, -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 10535, -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 10536, -- You already possess that temporary item.
        NO_COMBINATION                = 10541, -- You were unable to enter a combination.
